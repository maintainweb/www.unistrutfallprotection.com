...
function wp_pdfjs_func( $atts ) {
    ...
    if($download){
      $return_str = str_replace("<!-- DOWNLOAD_LINK -->", "<a title='Download' class='btn btn-default' alt='Download' href='{$presentation_url}' style='float: left;'><img src='{$pdfjs_image_url}glyphicons_134_inbox_in.png' style='width: 14px; height: 14px;'/> Download PDF</a>", $return_str);
    }
