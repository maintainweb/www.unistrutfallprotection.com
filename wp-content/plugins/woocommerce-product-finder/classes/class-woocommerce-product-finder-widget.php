 ...
 * - form()
 */
class Woo_Widget_Starter extends WP_Widget {
	...
	public function __construct() {
		...
		$this->woo_widget_description = __( 'Customisable Product Finder widget.', 'woocommerce' );
		$this->woo_widget_idbase = 'product_finder';
		$this->woo_widget_title = __( 'WooCommerce Product Finder', 'woocommerce' );
    ...
    public function form( $instance ) {   
		...
		$defaults = array(
						'title' => __( 'Product Finder', 'woocommerce' ),
						'use_category' => 1,
					);
...
?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title (optional):', 'woocommerce' ); ?></label>
			<input type="text" name="<?php echo $this->get_field_name( 'title' ); ?>"  value="<?php echo $instance['title']; ?>" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" />
		</p>
		<h4><?php _e( 'Select which criteria to include:' , 'woocommerce' ) ?></h4>
		<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'use_category' ); ?>"><?php _e( 'Product Category', 'woocommerce' ); ?></label>
	   	</p>
<?php
...
/* Register the widget. */
add_action( 'widgets_init', create_function( '', 'return register_widget("Woo_Widget_Starter");' ), 1 ); 
?>