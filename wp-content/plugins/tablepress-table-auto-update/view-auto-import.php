...
<?php
		...
		foreach ( $data['tables'] as $table ) {
			...
			<td><select name=\"auto_import[{$table['id']}][source_format]\"><option value=\"csv\"" . selected( $auto_import_table['source_format'], 'csv', false ) . ">CSV</option><option value=\"html\"" . selected( $auto_import_table['source_format'], 'html', false ) . ">HTML</option><option value=\"json\"" . selected( $auto_import_table['source_format'], 'json', false ) . ">JSON</option></select></td>
			<td><select class=\"source_type\" name=\"auto_import[{$table['id']}][source_type]\"><option value=\"url\"" . selected( $auto_import_table['source_type'], 'url', false ) . ">URL</option><option value=\"server\"" . selected( $auto_import_table['source_type'], 'server', false ) . ">File on server</option></select></td>
