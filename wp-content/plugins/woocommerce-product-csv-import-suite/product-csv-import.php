		...
		class WC_Product_CSV_Import_Suite {
			...
			public function tools( $tools ) {
				$tools['delete_products'] = array(
					'name'		=> __( 'Delete Products','woocommerce'),
					'button'	=> __( 'Delete ALL products','woocommerce' ),
					'desc'		=> __( 'This tool will delete all products allowing you to start fresh.', 'woocommerce' ),
					'callback'  => array( $this, 'delete_products' )
				);
				$tools['delete_variations'] = array(
					'name'		=> __( 'Delete Variations','woocommerce'),
					'button'	=> __( 'Delete ALL variations','woocommerce' ),
					'desc'		=> __( 'This tool will delete all product allowing you to start fresh.', 'woocommerce' ),
					'callback'  => array( $this, 'delete_variations' )
				);
				$tools['delete_orphaned_variations'] = array(
					'name'		=> __( 'Delete Orphans','woocommerce'),
					'button'	=> __( 'Delete orphaned variations','woocommerce' ),
					'desc'		=> __( 'This tool will delete variations which have no parent.', 'woocommerce' ),
			...
			public function delete_products() {
				...
				echo '<div class="updated"><p>' . sprintf( __( '%d Products Deleted', 'woocommerce' ), ( $result + $result2 ) ) . '</p></div>';
			}
			...
			public function delete_variations() {
				...
				echo '<div class="updated"><p>' . sprintf( __( '%d Variations Deleted', 'woocommerce' ), $result ) . '</p></div>';
			}
